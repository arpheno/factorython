...
def create_cargo_wagon_assignment_problem(entities,global_input,production_sites):
    ...
    for group_start in range(0, N, 4):
        ...
        for good in goods:
            ...
            problem+= flows[1, good] == tally[0,good]+tally[-1,good]
...
if __name__ == '__main__':
    ...
    create_cargo_wagon_assignment_problem(entities,global_input)
